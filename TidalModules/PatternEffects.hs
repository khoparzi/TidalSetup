...
let erun = (run 8)
    ...
    replicator' text1 num = [putStr (text1) | x <- replicate num text1]
    flood' text2 num = sequence_(replicator' text2 num)
    flood'' text2 = sequence_(replicator' (fst text2) (snd text2))
